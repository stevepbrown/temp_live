...
hat demonstrates some of the new features to check out in Bootstrap 4. Some of the features include Google Montserrat fonts, animation using Dan Eden&apos;s animate.css and the WOW jQuery plugin to watch the scrolling.
                  </p>
                  <p class="text-center"><a href="http://bootstrap4.guide">Download at Bootstrap4.guide</a></p>
                  <br>
                  <button class="btn btn-primary btn-lg" data-dismiss="modal" aria-hidden="true"> OK </button>
  ...
  <br/>
  <p>For a detailed article from scotch.io see <a href="https://scotch.io/bar-talk/whats-new-in-bootstrap-4">whats-new-in-bootstrap-4</a></p>
